#!/bin/bash
# Reverts SubtreeCrossover.cs/SymbolicExpressionTreeManipulator.cs back to their committed state in
# the sibling heal-research/HeuristicLab checkout and rebuilds, undoing apply-instrumentation.sh.
# Run this once you're done capturing --crossover-noop-output / --crossover-kernel-output /
# --crossover-donor-output / HL_MUTATION_TRACE data -- nothing from patches/ should ever be left
# applied (let alone committed) in heal-research/HeuristicLab.
#
